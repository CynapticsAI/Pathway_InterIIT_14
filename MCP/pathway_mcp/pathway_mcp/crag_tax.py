...
from prompts import CorrectiveRagTaxPrompt
...
rag_tax = CorrectiveRag(MODEL, CorrectiveRagTaxPrompt, MCP_CONFIG, tools_filter= tools_filter, service_tier="priority")