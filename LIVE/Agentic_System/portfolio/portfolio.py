...
from prompts import PortfolioAgentPrompt
...
market = PortfolioAgent(model = 'gpt-5-nano', prompt =PortfolioAgentPrompt, mcp_config=mcp_config, tools_filter = tools_filter)
...
pw.io.jsonlines.write(t,"./portfolio.jsonl")
