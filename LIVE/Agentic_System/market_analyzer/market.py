...
from prompts import MarketAnalysisPrompt2   
...
market = MarketAnalyzerAgent(model = 'gpt-5-nano', prompt = MarketAnalysisPrompt2, mcp_config=mcp_config, tools_filter = tools_filter)
...
pw.io.jsonlines.write(t,"./market.jsonl")
